 ...
 * silently deleting events before the consumer could read them. The retention
 * handed to Iggy must therefore be the second count multiplied to microseconds.
 */
