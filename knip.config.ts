...
const knipConfig: KnipConfig = {
  ignore: [
    ...
    // Consumed by CLI script and internal API route
    "src/lib/integrations/catalogSync.ts",
    // Billing barrel re-exports consumed by vortex-worker
    "src/lib/billing/index.ts",
    // Schema type exports consumed by seeds and external services
    "src/lib/db/schema/eventSchema.table.ts",
  ],
  ignoreDependencies: [
