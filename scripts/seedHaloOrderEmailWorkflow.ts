 ...
 * a buyer receipt and an optional seller notification via Resend.
 *
 ...
 *   VORTEX_API_KEY=<key> \
 *   VORTEX_ORGANIZATION_ID=<halo-store-org-id> \
 *   bun run scripts/seedHaloOrderEmailWorkflow.ts
 */

import template from "../../vortex-worker/src/workflows/templates/halo-order-confirmed.json";
...
const WORKFLOW_NAME = "halo-order-confirmed";
...
console.log("Done seeding halo-order-confirmed workflow");
